 ...
 *
 * @title 基础示例3
 * @description 使用RefTreeTableWithInput，清空功能
 *
 */
...
class Demo3 extends Component {
  constructor() {
    ...
    this.state = {
      ...
      condition: '',
      num: 0,
      matchData: [{ "rownum_": 2, "code": "002", "name": "人员2", "mobile": "15011323234", "refcode": "002", "refpk": "de2d4d09-51ec-4108-8def-d6a6c5393c3b", "id": "de2d4d09-51ec-4108-8def-d6a6c5393c3b", "refname": "人员2", "email": "22@11.com", "key": "de2d4d09-51ec-4108-8def-d6a6c5393c3b", "_checked": true }],
  ...
  onTreeChange = (record) => {
    ...
    this.setState({
      tableData:this.state.tableData.length==0?this.originTableData:[]
    })
  }
  onTreeSearch = (value) => {
    alert(value);
  ...
  clearFunc = () => {
    this.props.form.setFieldsValue({ code: { refname: '', refpk: '' } });
    this.setState({
      matchData: [],
      random: Math.random()
    })
      ...
      <div>
        <div className="demo-label">
          ...
          <RefTreeTableWithInput
            ...
            {...getFieldProps('code', {
              initialValue: '{"rownum_":2,"code":"002","name":"人员2","mobile":"15011323234","refcode":"002","refpk":"de2d4d09-51ec-4108-8def-d6a6c5393c3b","id":"de2d4d09-51ec-4108-8def-d6a6c5393c3b","refname":"人员2","email":"22@11.com","key":"de2d4d09-51ec-4108-8def-d6a6c5393c3b","_checked":true}',
              rules: [{
                message: '提示：请选择',
