...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo1 = function (_Component) {
	    ...
	    function Demo1() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.openFunc = function (type) {
	            (0, _index.openMess)({
	                title: type + '\u63D0\u793A',
	                type: type,
	                duration: 100,
	    ...
	    Demo1.prototype.render = function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                _beeButton2['default'],
	                { colors: 'dark', onClick: function onClick(e) {
	                        return _this2.openFunc('error');
	                    } },
	                '\u70B9\u51FB error'
	            ),
	            _react2['default'].createElement(
	                ...
	                { colors: 'warning', onClick: function onClick(e) {
	                        return _this2.openFunc('warning');
	                    } },
	                '\u70B9\u51FB warning'
	            ),
	            _react2['default'].createElement(
	                _beeButton2['default'],
	                { colors: 'success', onClick: function onClick(e) {
	                        return _this2.openFunc('success');
	                    } },
	                '\u70B9\u51FB success'
	            ),
	            _react2['default'].createElement(
	                _beeButton2['default'],
	                { colors: 'info', onClick: function onClick(e) {
	                        return _this2.openFunc('info');
	                    } },
	                '\u70B9\u51FB info'
	            )
	        );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function openMess(options) {
	  _notification = null;
	  if (!_notification) {
	    _notification = new _Notification2['default'](options);
	  }
	...
	var NotificationMess = function (_Component) {
	  ...
	  function NotificationMess(props) {
	    ...
	    _beeNotification2['default'].newInstance({
	      ...
	      className: _this.getTypeNotifica() + " " + "notification_mess"
	    }, function (n) {
	      return _this.notification = n;
	    });
	    return _this;
	  }
