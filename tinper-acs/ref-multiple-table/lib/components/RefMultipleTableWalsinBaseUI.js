...
var RefMultipleTableWalsinBaseUI = function (_Component) {
    _inherits(RefMultipleTableWalsinBaseUI, _Component);

    //激活页码
    //总页数
    //表头数据
    function RefMultipleTableWalsinBaseUI(props) {
        _classCallCheck(this, RefMultipleTableWalsinBaseUI);
    ...
    RefMultipleTableWalsinBaseUI.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    ...
    RefMultipleTableWalsinBaseUI.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
        var _this3 = this;
    ...
    /** end:表格操作*/
    RefMultipleTableWalsinBaseUI.prototype.render = function render() {
        var _this4 = this;
        ...
        var _props = this.props,
            ...
            _props$fliterColumn = _props.fliterColumn,
            fliterColumn = _props$fliterColumn === undefined ? [] : _props$fliterColumn,
    ...
    return RefMultipleTableWalsinBaseUI;
}(_react.Component);

exports["default"] = RefMultipleTableWalsinBaseUI;